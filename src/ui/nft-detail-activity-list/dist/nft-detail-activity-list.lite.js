...
function NftDetailActivityList(props) {
    return (React.createElement(stack_1["default"], { className: styles.container, direction: "vertical" },
        React.createElement(text_1["default"], { size: "xl", weight: "semibold", attributes: { marginBottom: "10" } }, "Activity"),
        React.createElement(stack_1["default"], { direction: "vertical", space: "10" },
